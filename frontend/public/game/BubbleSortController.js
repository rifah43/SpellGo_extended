class BubbleSortController {
  ...
  swap() {
    return new Promise((resolve) => {
      ...
      [
        this.ctx.stairs[this.ctx.currentLight],
        this.ctx.stairs[this.ctx.currentLight + 1],
      ] = [
        this.ctx.stairs[this.ctx.currentLight + 1],
        this.ctx.stairs[this.ctx.currentLight],
      ];
  ...
  async switching() {
    ...
    if (this.ctx.numberOfLights == 1) {
      ...
      this.ctx.scene.start("gameSucceed", {
        ...
        todo: [
          ...
          {
            text: "Find the potion book in the library",
    ...
    if (this.ctx.currentLight == 0) this.ctx.numberOfLights--;

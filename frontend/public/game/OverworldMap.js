  ...
  DemoRoom: {
    ...
    gameObjects: {
            ...
            events: [
              {
                ...
                text: [
                  {
                    string:
                      "You have to zip your data. Nowadays much data cannot be transmittted into the portal.",
                    speed: window.speeds.fast,
                  },
                ],
              },
      ...
      villageGate: new GameObject({
        ...
        collide: introDone
          ? null
          : [
              { x: utils.withGrid(35), y: utils.withGrid(92) },
              { x: utils.withGrid(36), y: utils.withGrid(92) },
            ],
      }),
      ...
      bubbleSortLantern: utils.getLantern(62, 78, "BubbleSort"),
      huffmanLantern: utils.getLantern(99, 62, "Huffman"),
      kmpLantern: utils.getLantern(93, 35, "KMP"),
    },
    ...
    cutsceneSpaces: {
      [utils.asGridCoord(63, 80)]: [
        {
          events: [{ type: "level", name: "bubbleSort" }],
        },
      ],
      [utils.asGridCoord(100, 64)]: [
        {
          events: [{ type: "level", name: "huffman" }],
        },
      ],
      [utils.asGridCoord(94, 37)]: [
        {
          events: [{ type: "level", name: "kmp" }],
        },
      ],
      [utils.asGridCoord(65, 75)]: [
        {
          events: [{ type: "changeRoom", map: "library" }],
        },
      ],
      ...
      [utils.asGridCoord(70, 47)]: [
        {
          events: [{ type: "changeRoom", map: "greenhouse" }],
        },
      ],
      [utils.asGridCoord(97, 62)]: [
        {
          events: [{ type: "changeRoom", map: "postOffice" }],
        },
      ],
      ...
      [utils.asGridCoord(70, 48)]: [
        {
          events: [{ type: "gate", what: "open", which: "greenhouseGate" }],
        },
      ],
      [utils.asGridCoord(65, 76)]: [
        {
          events: [{ type: "gate", what: "open", which: "libraryGate" }],
        },
      ],
      ...
      [utils.asGridCoord(64, 76)]: [
        {
          events: [{ type: "gate", what: "close", which: "libraryGate" }],
        },
      ],
